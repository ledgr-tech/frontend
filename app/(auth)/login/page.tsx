...
export default function LoginPage() {
  ...
  return (
    ...
    >
      <div aria-hidden="true" style={{ ...linhaLateral, left: "min(25%, calc(50% - 260px))" }} />
      <div aria-hidden="true" style={{ ...linhaLateral, left: "max(75%, calc(50% + 260px))" }} />
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "clamp(12px, 3vh, 40px) 0" }}>
        <form onSubmit={enviar} noValidate style={{ width: "100%", maxWidth: 424 }}>
          ...
          {/* ainda sem provedores: seguem o mesmo fluxo mock do botão Entrar */}
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: 12 }}>
            <button type="button" className="btn btn-secondary" disabled={entrando} onClick={entrar}>
              Entrar com Google
            </button>
            <button type="button" className="btn btn-secondary" disabled={entrando} onClick={entrar}>
              Certificado digital
      ...
      >
        <span>Sem credencial bancária: você envia o arquivo</span>
        <span aria-hidden="true">·</span>
        <span>O Ledgr lê arquivos e não movimenta dinheiro</span>
      </footer>
    </div>
  );
}
